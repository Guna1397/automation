...
def usercreation(context):
    ...
    time.sleep(5)
    gi = context.driver.find_element(By.XPATH, "//div/div[@class='oxd-table-cell oxd-padding-cell']").text
    print(gi)
    ...
    # context.driver.find_element(By.XPATH, "//div[@class='oxd-select-text-input' and text()='Admin']").text
