...
scenario_name = 'Patient(s) does not exist within DSP'

@scenario('test_get_patient_list_invalid.feature', str(scenario_name))
def test_JAYU_3349():
    pass
...
def send_an_api_request():
    ...
    try:
        ...
        endpoint1 = f"{baseurl}/{invalid_ID1}/patients"
        logger.info(f"Practitioner API URL used to retrieve Patient for specific practitioner is : {endpoint1}")
