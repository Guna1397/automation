...
create patient on opememr portal
    ...
    Sleep    2s
    Click Element    //select[@name="form_providerID"]//option[text()="${practitionerfirstname} ${practitionerlastname}"]         ##Parameter
    Sleep    2s

    Click Element    //select[@class="form-control form-control-sm mw-100 select-dropdown select2-hidden-accessible"]//option[text()="${practitionerfirstname} ${practitionerlastname}"]       #careteam
...
create Encounter on opememr portal
    ...
    CLick Element    (//select[@name="provider_id"]/option[text()= "${practitionerlastname} ${practitionerfirstname} "])      ##Parameter
