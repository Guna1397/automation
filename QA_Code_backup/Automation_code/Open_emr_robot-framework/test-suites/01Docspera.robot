...
User uploads a file in docspera-adls container of Docspera storage account
...
Check File Details
    ...
    Run Keyword If   ${status10}    Append To File  ${API_Output_filePath}${TC_ID}.txt  PASS : DSEP Patient id is generated as ${fileACK["acknowledgement"]["DSEP PatientID"]}${\n}
    Run Keyword If  not ${status10}    Append To File  ${API_Output_filePath}${TC_ID}.txt  FAIL : DSEP Patient id is not generated as ${fileACK["acknowledgement"]["DSEP PatientID"]}${\n}
