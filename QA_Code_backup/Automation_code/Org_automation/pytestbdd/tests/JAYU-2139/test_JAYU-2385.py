...
local_path = '../test-data/JAYU-2385/'

@pytest.fixture()
def test_jira_id():
    return "JAYU-2385"

@scenario('test_JAYU-2385.feature', 'Payload is missing mandatory info with valid user role')
def test_JAYU_2385():
    pass
...
@then('Error response is generated with 400 BAD REQUEST')
def response_id():
    logger.info('Step:5')
